...
/* JQ fixed on 02-27-2008 */ 
/* Define to 1 to solve socket.c compilation issue */
...
//LAL HACKS
//typedef int (*getnameinfo_func2) (const struct sockaddr *,
//        socklen_t, char *, size_t, char *, size_t, int);

typedef int (*getnameinfo_func2) (const struct sockaddr *sa, socklen_t salen, char *host,
         size_t hostlen, char *serv, size_t servlen, int flags);

#ifdef SOLARIS64BIT
/* JQ fixed on 02-27-2008 */
// getnameinfo_func2 getnameinfo_ptr = getnameinfo;
/*  Solaris 64bit only, AIX does not like this */ 
extern int             getnameinfo(const struct sockaddr *_RESTRICT_KYWD,
                        socklen_t, char *_RESTRICT_KYWD, socklen_t,
                        char *_RESTRICT_KYWD, socklen_t, int);
#endif

int my_getnameinfo(const struct sockaddr *sa, socklen_t salen, char *host,
         size_t hostlen, char *serv, size_t servlen, int flags)
{
	return getnameinfo(sa, salen, host, hostlen, serv, servlen, flags);
}

getnameinfo_func2 getnameinfo_ptr = my_getnameinfo;
