...
#define INI_GREENPLUM	"Greenplum"
#define ABBR_GREENPLUM	"GP"
...
#define BIT_GREENPLUM			(1L<<28)

#define EFFECTIVE_BIT_COUNT			29
...
#define DEFAULT_PROTOCOL			"6.4-0"	/* the latest protocol is
												 * the default */
